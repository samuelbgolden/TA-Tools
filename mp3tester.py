...
def main():
    ...
    TESTING_ENV = "C:/Users/Samuel/Google Drive/School/TACS340/2021/repos/mp3Tester"
    ...
    p = subprocess.Popen(f"subl {src_file1} {src_file2} {test_file}", shell=True)
    ...
    p2 = subprocess.Popen("stack build",cwd=os.path.abspath(args.dir), shell=True)
    p1.wait()   
    p2.wait()
    ...
    p1.wait()
    print("\n\n========================= STUDENT TESTS =========================")
    p2 = subprocess.Popen(f"echo {yaml_data['author']} & echo STUDENT & stack test --coverage", cwd=os.path.abspath(args.dir), shell=True)
    p2.wait()
    print("\n\n========================= EXEC =========================")
    p3 = subprocess.Popen(f"echo {yaml_data['author']} & echo EXEC & stack exec mp3 10000", cwd=os.path.abspath(TESTING_ENV), shell=True)
    p3.wait()
